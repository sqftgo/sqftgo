    ...
    switch (currentStep) {
        ...
        return (
          ...
          >
            <div className="flex flex-col gap-1.5">
              <label htmlFor="citySelect" className="font-extrabold text-indigo text-sm">City *</label>
              <select
                id="citySelect"
                value={city}
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="localityInput" className="font-extrabold text-indigo text-sm">Locality *</label>
              <input
                id="localityInput"
                type="text"
                required
              ...
              />
              <span className="text-[10px] text-charcoal/50 font-medium">The sub-locality area or neighborhood</span>
            </div>
          </motion.div>
        );
      ...
      case 2: // Specifications
        return (
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="sizeInput" className="font-extrabold text-indigo">Super Area (sq.ft.) *</label>
              <input
                id="sizeInput"
                type="number"
                required
            ...
            {(type !== "Industrial Plot" && type !== "Agricultural Land") && (
              <div className="flex flex-col gap-1.5">
                <label htmlFor="furnishSelect" className="font-extrabold text-indigo">Furnishing State</label>
                <select
                  id="furnishSelect"
                  value={furnished}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {AMENITIES_LIST.map((am) => (
                  <label key={am} className="flex items-center gap-2 cursor-pointer text-charcoal/70 font-semibold text-xs">
                    <input
                      type="checkbox"
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="descInput" className="font-extrabold text-indigo">Detailed Description</label>
              <textarea
                id="descInput"
                rows={3}
                value={description}
            ...
            {mockUploadedImages.length > 0 && (
              <div className="flex flex-wrap gap-4 mt-2">
                {mockUploadedImages.map((img, idx) => (
                  <div key={idx} className="relative w-24 h-16 rounded-xl overflow-hidden border border-sand shadow-sm flex-shrink-0">
          ...
          >
            <div className="flex flex-col gap-1.5">
              <label htmlFor="priceInput" className="font-extrabold text-indigo text-sm">
                {purpose === "rent" || purpose === "lease" ? "Monthly Rent (Rupees) *" : "Total Price (Rupees) *"}
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder={purpose === "rent" || purpose === "lease" ? "e.g. 15000" : "e.g. 7500000"}
      ...
      case 5: // Review
        return (
          ...
          >
            <h3 className="font-serif font-black text-lg text-indigo uppercase tracking-wide">Recap Details</h3>
            <div className="grid grid-cols-2 gap-4 bg-sand/20 p-5 rounded-2xl border border-sand/80">
              <div className="flex flex-col">
                ...
                <span className="text-charcoal font-bold capitalize">{purpose === "rent" ? "For Rent" : purpose === "lease" ? "For Lease" : "For Sale"}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] font-extrabold text-charcoal/50 uppercase">Property Type</span>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-charcoal font-bold truncate">{locality}, {city}</span>
              </div>
              {(type !== "Industrial Plot" && type !== "Agricultural Land") && (
                <div className="flex flex-col">
                  <span className="text-[10px] font-extrabold text-charcoal/50 uppercase">BHK Layout</span>
                  <span className="text-charcoal font-bold">{bhk} BHK</span>
                </div>
              )}
              <div className="flex flex-col">
                <span className="text-[10px] font-extrabold text-charcoal/50 uppercase">Super Area</span>
            ...
            <p className="text-xs text-charcoal/50 leading-relaxed italic mt-2">
              By submitting this property, you certify that all information details are correct. Listing will go live instantly under the results list.
            </p>
          </motion.div>
        );
        ...
        {!isSubmitted ? (
          ...
          >
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl md:text-4xl font-serif font-black text-indigo tracking-tight">List Your Property</h1>
            ...
            {/* Form Box */}
            <form onSubmit={handleSubmit} className="bg-white/80 glassmorphism rounded-3xl p-6 md:p-8 shadow-sm flex flex-col gap-6 mt-4 relative overflow-hidden">
          ...
          >
            ...
            <h2 className="font-serif font-black text-2xl text-indigo mb-2 tracking-tight">Property Listed Successfully!</h2>
            <p className="text-sm text-charcoal/60 max-w-sm leading-relaxed mb-8 font-medium">
              Your property has been submitted successfully and will display to all users browsing the heritage listings.
            </p>
