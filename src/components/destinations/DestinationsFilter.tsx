...
export default function DestinationsFilter({
  ...
  return (
    <div className="flex flex-col items-center gap-3 mb-12 relative z-30">
      <div className="flex items-center gap-2 overflow-x-auto max-w-full pb-3 no-scrollbar px-4 bg-white/70 backdrop-blur-md rounded-full shadow-sm border border-sand p-1.5">
        ...
        {tags.map(tag => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition-all cursor-pointer flex items-center gap-1.5 ${
                isActive 
            ...
            >
              ...
              <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-black ${
                isActive ? "bg-white/20 text-white" : "bg-sand text-charcoal/50"
              }`}>
