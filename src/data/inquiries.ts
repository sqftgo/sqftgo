import type { AssistanceRequest, GeneralEnquiry } from "@/types/inquiry";
  ...
  "prop-1": [
    {
      ...
      message:
        "Hi, I am interested in viewing this lakeview villa this Sunday. Is it available for a visit?",
      date: "2026-06-14",
    },
  ],
  "prop-3": [
  ...
  "prop-9": [
    {
      ...
      message:
        "We want to schedule a visit for our team of 15 people. Please let us know when is convenient.",
      date: "2026-07-15",
    },
  ],
};
