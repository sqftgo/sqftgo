...
export default function WeddingVenueCard({ venue, onInquire }: WeddingVenueCardProps) {
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl bg-white shadow-[0_1px_2px_oklch(0_0_0/0.04),0_12px_28px_oklch(0_0_0/0.06)] transition-[transform,box-shadow] duration-300 hover:-translate-y-1 hover:shadow-[0_1px_2px_oklch(0_0_0/0.04),0_18px_40px_oklch(0_0_0/0.10)]">
      <div className="relative h-56 w-full shrink-0 overflow-hidden bg-sand/20">
        ...
        <div className="absolute top-3 left-3 right-3 z-10 flex items-start justify-between gap-2">
          ...
          <span className="shrink-0 rounded-full bg-terracotta px-3 py-1 text-[9px] font-black uppercase tracking-wider text-white shadow-[0_4px_12px_oklch(0.5_0.12_40/0.35)]">
            {venue.pricePerEvent}
          </span>
        </div>
