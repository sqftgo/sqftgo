...
export const initialNotifications: Notification[] = [
    { id: "notif-1", title: "Welcome to SqftGo", message: "Your account has been set up successfully.", type: "success", read: false, date: "2026-07-16", forRole: "all" },
...
export const initialActivityLogs: ActivityLog[] = [
    { id: "log-1", action: "Property Approved", performedBy: "admin@sqftgo.com", role: "Admin", target: "prop-1 — Ultra Luxury Lake-Facing Villa", timestamp: "2026-07-16 14:32:00" },
    { id: "log-2", action: "User Role Changed", performedBy: "admin@sqftgo.com", role: "Admin", target: "broker@sqftgo.com → broker", timestamp: "2026-07-15 10:15:00" },
    ...
    { id: "log-4", action: "Property Deleted", performedBy: "admin@sqftgo.com", role: "Admin", target: "prop-draft-001", timestamp: "2026-07-13 16:22:00" },
    { id: "log-5", action: "Inquiry Submitted", performedBy: "user@sqftgo.com", role: "User", target: "prop-2 — Premium 3 BHK Flat in C-Scheme", timestamp: "2026-07-12 11:05:00" },
  ];

export const initialMockUsers: MockUser[] = [
    { id: "usr-1", name: "Arjun Sharma", email: "user@sqftgo.com", role: "user", status: "active", joinedDate: "2026-01-15", inquiriesCount: 4 },
    ...
    { id: "usr-4", name: "Rajesh Mehta", email: "broker@sqftgo.com", role: "broker", status: "active", joinedDate: "2025-11-10", inquiriesCount: 0 },
    ...
    { id: "usr-6", name: "Admin User", email: "admin@sqftgo.com", role: "admin", status: "active", joinedDate: "2025-06-01", inquiriesCount: 0 },
  ];
